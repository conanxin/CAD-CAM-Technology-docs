...
**项目全景展示（V10A）**：全站模块与演进时间线、读者类型入口、Showcase 入口表 → [查看](https://conanxin.github.io/CAD-CAM-Technology-docs/project-showcase.html)
...
- [x] V10A 首页 Showcase 化 + project-showcase 全景页
- [ ] V10B 全站质量审计
- [ ] V10C 最终发布收口
- [ ] v1.0.0 稳定版
