...
1. 了解 CAD/CAM 建模技术的发展历程与几何信息、拓扑信息的基本概念
2. 掌握线框建模、表面建模、实体建模三大建模方法的原理与优缺点对比
3. 理解特征建模、参数化建模、变量化建模及装配建模的核心思想
...
1. 线框、表面、实体三种建模方法的优缺点分别是什么？分别适用于哪些场景？
2. B-Rep 与 CSG 两种实体建模表示法有什么区别？各自的优势和局限是什么？
3. 为什么特征建模被认为是 CAD/CAPP/CAM 集成的关键技术？
